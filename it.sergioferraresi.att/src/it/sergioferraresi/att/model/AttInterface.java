...
/**
 * Identifies the Interfaces for the ATT Program.
 * 
 * @author psf563
 */
public enum AttInterface {
	/**
	 * Identifies the Command Line Interface (CLI).
	 */
	CONSOLE,
	/**
	 * Identifies the Graphical User Interface (GUI).
	 */
	WINDOW
}